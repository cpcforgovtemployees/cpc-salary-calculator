    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-green-50 via-white to-blue-50 rounded-2xl p-8 sm:p-10 border-2 border-green-200 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-700">
                  All calculations validated against 7th CPC report, Ministry of Finance circulars, and DOPT guidelines.
                </p>
              </div>
              
              <div className="text-center">
                <div className="text-4xl font-bold text-blue-600 mb-2">⚡</div>
                <h3 className="font-semibold text-gray-800 mb-2">Quarterly Updates</h3>
                <p className="text-sm text-gray-700">
                  DA, interest rates, tax slabs, and 8th CPC projections updated every quarter with latest announcements.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-700">
                  No data collection, no tracking, no ads. Your salary calculations stay private and secure.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Support Section - COMPLETELY VISIBLE */}
