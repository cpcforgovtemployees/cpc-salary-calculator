      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
            Enter your <strong>Old DA percentage</strong>, <strong>New DA percentage</strong>,
            and number of <strong>pending months</strong> to calculate total Dearness Allowance arrears
            based on your <strong>Basic Pay</strong>.
          </p>
        </div>
